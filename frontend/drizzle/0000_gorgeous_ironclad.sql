...
CREATE TABLE IF NOT EXISTS "plattform_gitlab_account" (
	"user_id" varchar(255) NOT NULL,
	"provider_account_id" varchar(255) PRIMARY KEY NOT NULL,
	"refresh_token" text,
	"access_token" text,
	"expires_at" integer,
	"created_at" integer,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "plattform_gitlab_account" ADD CONSTRAINT "plattform_gitlab_account_user_id_plattform_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."plattform_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "gitlab_account_user_id_idx" ON "plattform_gitlab_account" USING btree ("user_id");--> statement-breakpoint
